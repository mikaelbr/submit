...
viewSubmissionDetails submission model =
    div []
        ...
        , div [ class <| "edit-intro " ++ hideIfNotEditable submission.editable ]
            ...
            , p [ class "ingress" ] [ text "Temaet for kommende fagdag er «XXXXXXXXXX» – XXXXXXXXX." ]
            , div [ class "help-part" ]
                [ strong [] [ span [] [ text "XX. XXXX 2017" ], text "Frist for innsending" ]
            ...
            , div [ class "help-part" ]
                [ strong [] [ span [] [ text "XX. XXXX 2017" ], text "Foredrag blir valgt ut" ]
            ...
            , div [ class "help-part" ]
                [ strong [] [ span [] [ text "10. November 2017" ], text "Fagdag! Wooh!" ]
