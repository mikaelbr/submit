    ...
    div [ class "wrapper" ]
        ...
        , div [ class "edit-intro" ]
            ...
            , div [ class "help-part" ]
                ...
                , p [] [ text "Start by creating your talk by filling in all the fields. We'll auto-save the talk for you as you edit, making sure you not lose your great ideas." ]
                ]
            , div [ class "help-part" ]
                [ strong [] [ span [] [ text "March 27th" ], text "Get some feedback" ]
                , p [] [ text "If you get your first draft before March 27th, we'll try to give you some personal feedback on your talk. We receive hundreds of talks, so we can't promise the world, but we'll do our best." ]
                ]
            , div [ class "help-part" ]
                [ strong [] [ span [] [ text "April 24th" ], text "Get reviewed" ]
                , p [] [ text "After April 24th, the program committee will go through all talks and select the one that will be a part of JavaZone 2017." ]
                ]
            , div [ class "help-part" ]
                [ strong [] [ span [] [ text "June 26th" ], text "Talk at the conference" ]
                , p [] [ text "By the end of June, all speakers will be get info about whether their talk is selected or not. Fingers crossed!" ]
                ]
            ]
